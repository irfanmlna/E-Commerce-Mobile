...
import 'package:project_store/models/model_checkout.dart';
import 'package:project_store/screens/payment_detail.dart';
            ...
            Container(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return ProductItem(
                    imageUrl: '$url/image/${widget.items[index].productImage}',
                    title: widget.items[index].productName,
                    subtitle: widget.items[index].productDesc,
