...
import 'package:project_store/model/model_edituser.dart';
...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  TextEditingController txtAddress = TextEditingController(); // Add address controller
  ...
  Future getSession() async {
    ...
    setState(() {
      ...
      address = pref.getString("address") ?? ''; // Retrieve address
    });
  }
  ...
  Future<ModelEditUser?> registerAccount() async {
    try {
      ...
      http.Response res =
        ...
        "email": txtEmail.text,
        "address": txtAddress.text, // Update address
      });
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  controller: txtAddress, // Add address field
                  validator: (val) {
                    return val!.isEmpty ? "Tidak boleh kosong" : null;
                  },
                  decoration: InputDecoration(
